...
def main(args):
    ...
    enc_saver.restore(sess, './E_Model/E_data_1_epochs_20_batchsize_5_rate_0.001_enc')
    dec_saver.restore(sess, './E_Model/E_data_1_epochs_20_batchsize_5_rate_0.001_dec')
