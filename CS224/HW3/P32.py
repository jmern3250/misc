...
# BETA = 0.05 
# DELTA = 0.5
# patient0 = snap.GetMxDegNId(IMDB)
# IMDB_infected = []
...
# BETA = 0.05 
# DELTA = 0.5
# patient0 = snap.GetMxDegNId(ER)
# ER_infected = []
# for sim in range(100):
# 	ER_nodes = dict.fromkeys(ER_nodes.keys(), 0)
# 	ER_nodes[patient0] = 1
# 	done = False
# 	while not done:
...
# BETA = 0.05 
# DELTA = 0.5
# patient0 = snap.GetMxDegNId(PA)
# PA_infected = []
# for sim in range(100):
# 	PA_nodes = dict.fromkeys(PA_nodes.keys(), 0)
# 	PA_nodes[patient0] = 1
# 	done = False
# 	while not done:
